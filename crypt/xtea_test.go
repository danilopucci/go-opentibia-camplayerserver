...
func TestXteaDecrypt(t *testing.T) {
	...
	dataToBeDecrypted := []byte{0xb5, 0x8c, 0xf2, 0xfa, 0xe0, 0xc0, 0x40, 0x09}
	...
	XteaDecrypt(dataToBeDecrypted, encryptionKey)

	if !reflect.DeepEqual(dataToBeDecrypted, want) {
		t.Errorf("got %x, wanted %x", dataToBeDecrypted, want)
	}
}
